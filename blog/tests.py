...
class TestView(TestCase):
    ...
    def test_search(self):
        ...
        self.assertIn(self.post_004.title, main_area.text)
    ...
    def test_create_post(self):
        ...
        self.assertTrue(Tag.objects.get(name='new tag')) #가지고 있는가
    ...
    def test_update_post(self):
        ...
        self.client.login(username='James',password='somepassword')
        response = self.client.get(update_url)
        self.assertEqual(response.status_code, 403) #403 점근 권한 금지
        ...
        self.assertIn('somd tag', main_area.text)
